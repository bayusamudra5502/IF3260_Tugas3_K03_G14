...
var Importer = /** @class */ (function () {
    function Importer(objectManager, objectLoader, fileId) {
    ...
    Importer.prototype.getFileData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var file;
            return __generator(this, function (_a) {
                file = this.fileObject.files[0];
    ...
    Importer.prototype.import = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFileData()];
                    case 1:
                        fileData = _a.sent();
                        ...
                        object = this.objectLoader.fromJson(fileData);
