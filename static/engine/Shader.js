...
var Shader = /** @class */ (function () {
    function Shader(vertexShaderId, fragmentShaderId, canvas, shaderAttribute) {
    ...
    Shader.prototype.loadCode = function () {
    ...
    Shader.prototype.compileCode = function (type, code) {
